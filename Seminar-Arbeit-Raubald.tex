...
\begin{document}
    ...
    \include{chapters/20_Grundlagen}
    \include{chapters/30_Herausforderungen_Risiken}
    \include{chapters/40_Herausforderungen_Lösungsansätze}
    \include{chapters/50_Lösungsansätze}
    \include{chapters/60_Abschluss_Ausblick}
