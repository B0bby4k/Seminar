...
\begin{document}
    ...
    %\include{chapters/30_Grundlagen}
    \include{chapters/30_TenderInsights}
    \include{chapters/40_TenderSniffer}
    %\include{chapters/50_Reflexion_Bewertung}
    \include{chapters/60_Fazit_Ausblick}
    \include{chapters/70_Anhang}
    \include{chapters/80_Eidesstattliche_Erklaerung}
